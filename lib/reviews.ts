    ...
    items: [
      {
        ...
        body: "One box covers the flat incision and the zones that move. Six weeks of both, with no reordering gap in the middle.",
        facets: [
      ...
      },
      {
        ...
        age: "3 weeks ago",
        stars: 5,
        title: "One scar, two kinds of skin",
        body: "The line runs from my collarbone to my jaw. Patch on the flat part, gel on the rest. Six weeks later it reads as one, and much flatter.",
        facets: [
